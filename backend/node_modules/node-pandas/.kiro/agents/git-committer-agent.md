...
1. Run `git diff --cached` to see what files are staged (skip if you have already committed the changes a min before, in this case feel free to push the changes)
